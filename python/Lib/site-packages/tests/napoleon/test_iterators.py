...
if sys.version_info[0] >= 3:
    ...
    u = lambda s: str(s.replace(r'\\', r'\\\\'), "unicode_escape")
...
class BaseIteratorsTest(TestCase):
    ...
    def assertNext(self, it, expected, is_last):
        ...
        if is_last:
            ...
            self.assertRaisesTwice(StopIteration, it.__next__)
        else:
            self.assertTrueTwice(it.has_next)
...
class PeekIterTest(BaseIteratorsTest):
    ...
    def test_next_with_multi(self):
        ...
        it = peek_iter(a)
        self.assertFalseTwice(it.has_next)
        self.assertRaisesTwice(StopIteration, it.__next__, 2)
    ...
    def test_next_with_one(self):
        ...
        it = peek_iter(a)
        self.assertFalseTwice(it.has_next)
        self.assertRaisesTwice(StopIteration, it.__next__, 1)
    ...
    def test_next_with_zero(self):
        ...
        it = peek_iter(a)
        self.assertFalseTwice(it.has_next)
        self.assertRaisesTwice(StopIteration, it.__next__, 0)

        a = ['1']
        it = peek_iter(a)
        self.assertTrueTwice(it.has_next)
        self.assertEqualTwice([], it.__next__, 0)
        self.assertTrueTwice(it.has_next)
        self.assertEqualTwice([], it.__next__, 0)
